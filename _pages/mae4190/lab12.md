...
Professor Helbling mentioned in lecture that a robot can use its right-side sensor to track a wall. Segments 4, 6, 7, and 8 all travel along walls, so I built the controller around exactly that idea.
